...
\begin{equation}
	R = g^{ij} R^m_{imj}.
\end{equation}
The Ricci scalar can be viewed as a measure of how much the manifold at the point of computation differs from flat space. For euclidean spaces, the Ricci scalar is 0 \cite{GeneralRelativityBook}. How the Ricci scalar can be a measure of complexity of a neural network will be mentioned at the end of \cref{sec:FisherInterpretation}.
