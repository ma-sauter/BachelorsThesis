...
\img{text/MachineLearningBasics/plots/mnist_plot.pdf}{14cm}{Displayed in this figure are 4 examples of input values of the MNIST dataset. This dataset represents handwritten digits from 0 to 9. Each input consists of a 28 by 28 grid of grayscaled pixel values.}{fig:MNIST_examples}
...
\subsection{Other optimizers}\label{sec:OtherOptimizers}
